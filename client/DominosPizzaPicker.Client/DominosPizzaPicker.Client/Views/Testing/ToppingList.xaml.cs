...
namespace DominosPizzaPicker.Client
{
    ...
    public partial class ToppingList : ContentPage
    {
        ToppingManager manager;

        public ToppingList()
        {
            InitializeComponent();

            manager = ToppingManager.DefaultManager;
        ...
        private async Task RefreshItems(bool showActivityIndicator, bool syncItems)
        {
            ...
            {
                toppingList.ItemsSource = await manager.GetToppingsAsync(syncItems);
            }
        }     
